...
int main()
{
    ...
    unsigned int vertexShader; //declare vertex shader object
    ...
    //delete shader objects after linking (we don't need them anymore)
    glDeleteShader(vertexShader);
    glDeleteShader(fragmentShader);

    //mapping vertex data to vertex attributes
    ...
    //create Vertex Array Object (VAO) for storing vertex attributes together with an VBO
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        //check window events and swap buffers
        glfwPollEvents();    
